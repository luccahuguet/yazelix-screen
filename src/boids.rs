...
const PREY_EAST: [BoidSpriteCell; 8] = [
    sprite_cell(0, 0, TAIL, BOID_RIGHT_HALF),
    sprite_cell(1, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(2, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(3, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(4, 0, BODY, BOID_BLOCK),
    sprite_cell(5, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(6, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(7, 0, HEAD, BOID_RIGHT_HALF),
];
...
const PREY_WEST: [BoidSpriteCell; 8] = [
    sprite_cell(0, 0, HEAD, BOID_LEFT_HALF),
    sprite_cell(1, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(2, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(3, 0, BODY, BOID_BLOCK),
    sprite_cell(4, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(5, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(6, 0, BODY, BOID_UPPER_HALF),
    sprite_cell(7, 0, TAIL, BOID_LEFT_HALF),
];
...
mod tests {
    ...
    fn boid_visual_identity_is_stable_and_directional() {
        ...
        assert_eq!(prey_east, vec!["tbbbbbbh"]);
